...
public class ReceptionistScheduleService extends CustomerScheduleService {
	...
	public void run(Context context) {
		...
		try {
			...
			while (!(context.getPage() instanceof CustomerService) &&
					!(context.getPage() instanceof CustomerScheduleService)) {
			...
			if (context.getPage() instanceof CustomerService) {
				...
				context.setPage(new ReceptionistScheduleService());
			}
